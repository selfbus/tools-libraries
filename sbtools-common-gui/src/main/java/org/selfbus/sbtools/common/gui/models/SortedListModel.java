...
public class SortedListModel<E> extends AbstractListModel<E>
{
   ...
   private void unsortedIntervalAdded(ListDataEvent e)
   {
       ...
       * model pointers into the decorated model. We must increment indices that
       * intersect with the insertion point in the decorated model.
       */
      for (SortedListEntry entry : sortedModel)
      {
