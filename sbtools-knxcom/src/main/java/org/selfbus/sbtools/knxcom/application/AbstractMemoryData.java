 ...
 */
public abstract class AbstractMemoryData extends AbstractMemory
{
   private byte[] data;
    ...
    *            63 bytes.
    */
   protected AbstractMemoryData(int address, byte[] data)
   {
      super(address);
      setData(data);
   }
    ...
    *            63 bytes.
    */
   protected AbstractMemoryData(MemoryLocation location, byte[] data)
   {
      super(location, 0);
      setData(data);
   }
   ...
   public boolean equals(Object o)
   {
      ...
      if (!(o instanceof AbstractMemoryData))
         return false;

      final AbstractMemoryData oo = (AbstractMemoryData) o;
