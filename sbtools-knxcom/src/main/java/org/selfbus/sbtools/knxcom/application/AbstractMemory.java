 ...
 */
public abstract class AbstractMemory extends AbstractApplication
{
    ...
    */
   protected AbstractMemory(int address)
   {
    ...
    */
   protected AbstractMemory(MemoryLocation location, int offset)
   {
